...
return(
    <View style={styles.container}>
        <Item style={props.underline? null:{borderColor:'transparent'} } floatingLabel    >
            ...
            <Input secureTextEntry={props.title=="PASSWORD"? true :false} value={props.defaultValue} editable={!props.disabled} keyboardType={props.keyboardType} multiline={true} onChangeText={props.onChangeText}/>
        </Item>
